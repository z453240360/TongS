package com.example.dongdong.myview.adapter;
...
import static com.example.dongdong.myview.R.id.mTxt_jine;
import static com.example.dongdong.myview.R.id.mTxt_shenqinshijian;
import static com.example.dongdong.myview.R.id.mTxt_time;
import static com.example.dongdong.myview.R.id.mTxt_wuqian;
import static com.example.dongdong.myview.R.id.tv_test;
...
public class LikeListAdapter extends RecyclerView.Adapter<LikeListAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //1. 初始化item的布局
        View view = mInflater.inflate(R.layout.kehu, parent, false);
        //2. 创建出来ViewHolder对象
...
//        holder.tv_test.setLayoutParams(layoutParams);
        ...
        holder.mTxt_dangqianjiedian.setText(str);
    }


    public class MyViewHolder extends RecyclerView.ViewHolder {
        private TextView mTxt_dangqianjiedian,mTxt_jianban,
                mTxt_wuqian,mTxt_jine,mTxt_shenqinshijian,mTxt_time;
        ...
        public MyViewHolder(View itemView) {
            ...
            mTxt_shenqinshijian = (TextView) itemView.findViewById(R.id.mTxt_shenqinshijian);
